...
<!--      </span>-->
<!--&lt;!&ndash;      <span class="meta-content">&ndash;&gt;-->
<!--&lt;!&ndash;        <span v-for="(category, index) in categories" :key="index">&ndash;&gt;-->
<!--&lt;!&ndash;          <a href="javascript:void(0);" @click="goToLink('/archives', 'category', category)" target="_self" :title="category">{{ category }}</a>&ndash;&gt;-->
<!--&lt;!&ndash;          <span v-if="index != categories.length - 1">, </span>&ndash;&gt;-->
<!--&lt;!&ndash;        </span>&ndash;&gt;-->
<!--&lt;!&ndash;      </span>&ndash;&gt;-->
<!--    </div>-->
...
<!--      </span>-->
<!--&lt;!&ndash;      <span class="meta-content">&ndash;&gt;-->
<!--&lt;!&ndash;        <span v-for="(tag, index) in tags" :key="index">&ndash;&gt;-->
<!--&lt;!&ndash;          <a href="javascript:void(0);" @click="goToLink('/archives', 'tag', tag)" target="_self" :title="tag">{{ tag }}</a>&ndash;&gt;-->
<!--&lt;!&ndash;          <span v-if="index != tags.length - 1">, </span>&ndash;&gt;-->
<!--&lt;!&ndash;        </span>&ndash;&gt;-->
<!--&lt;!&ndash;      </span>&ndash;&gt;-->
<!--    </div>-->
  </div>
