...
export const themeConfig: DefaultTheme.Config = {
  ...
  // 编辑链接配置
  // editLink: {
  //   pattern: 'https://github.com/printf200/printf200-blog/tree/master/docs:path',
  //   text: '不妥之处，敬请雅正'
  // },
  // 搜索配置（二选一）
  search: {
  ...
  // 导航栏右侧社交链接配置
  socialLinks: [
    { icon: 'github', link: 'https://github.com/printf200/printf200-blog' },
  ],

  // 自定义扩展: 文章元数据配置
  // @ts-ignore
  articleMetadataConfig: {
    author: 'Printf200', // 文章全局默认作者名称
    authorLink: '/index', // 点击作者名时默认跳转的链接
